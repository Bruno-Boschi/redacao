        ...
        <div class="col-12 d-flex no-block align-items-center">
            ...
            <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/avisos/pesquisar">Pesquisar</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
@section('scrpts')
    ...
    <script src="{{URL('/assets/painel/js/avisos/')}}/pesquisar.js"></script>
@stop