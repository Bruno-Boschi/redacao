...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                @if (isset($usuario) && $usuario->ativo == 2)
                    <form id="dados_cadastro" action="/usuarios/aprovar" method="get">
                    @else
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control date-inputmask" placeholder="Data Nascimento"
                                name="data_nascimento" value="{{ $dataNascimento }}">
                        </div>
                    </div>
                </div>
                ...
                @if (isset($usuario) && $usuario->ativo == 2)
                    <input type="submit" class="btn btn-primary my-4" value="Aprovar">
                @else
