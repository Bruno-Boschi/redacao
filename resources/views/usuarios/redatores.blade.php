@extends('layout.app')
@section('title', 'Redatores')
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Redatores</h4>
                <div class="ms-auto text-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/usuarios/redatores">Redatores</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="btn-group mt-2" role="group">
                                <a href="/usuarios/create-edit/R" class="btn btn-success text-white">Cadastrar</a>
                            </div>
                        </div>
                        <div class="col-md-2">
                        </div>
...
@section('scrpts')
    ...
    <script src="{{ URL('/assets/painel/js/usuarios/') }}/redatores.js"></script>
@stop
