        ...
        <div class="col-12 d-flex no-block align-items-center">
            ...
            <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/usuarios/administradores">Administradores</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="btn-group mt-2" role="group">
                            <a href="/usuarios/create-edit/A" class="btn btn-success text-white">Cadastrar</a>
                        </div>
                    </div>
                    <div class="col-md-2">
                    </div>
...
<script src="{{URL('/assets/painel/js/usuarios/')}}/administradores.js"></script>
@stop