        ...
        <div class="col-12 d-flex no-block align-items-center">
            ...
            <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/financeiros/lista-solicitacoes-pagamento">Solicitações Pagamentos</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div id="boxes">
    <div id="dialog1" class="window" style="height: 435px;">
        <div class="d-header">
                ...
                <form method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="row descricao_reprovacao" style="display:none;">
                        <div class="col-md-12">
                            ...
                            <textarea name="descricao" id="descricao" class="textarea_editor form-control" rows="2"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="{{URL('/assets/painel/js/financeiros/')}}/lista-solicitacoes-pagamento.js"></script>
<script>
    ajaxUpload('#comprovante_pagamento', '<?php echo csrf_token(); ?>');
</script>
@stop