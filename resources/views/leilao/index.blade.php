@extends('layout.app')
@section('title', 'Leilão Matérias')
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Leilão Matérias</h4>
                <div class="ms-auto text-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/leilao-materias">Leilão Matérias</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
...
@section('scrpts')
    ...
    <script src="{{ URL('/assets/painel/js/leilao/') }}/index.js"></script>
@stop
